            ...
            <div className='relative m-auto w-80 h-72 bflex items-start lg:w-96'>
              ...
              <div className="absolute bottom-10 right-0 w-36 h-20  lg:w-40 ">
                <div className="relative w-full h-full ">
                  <Link to={'/about'} className="w-32 h-14 bg-secondary text-white flex items-center justify-center"> Read More </Link>
                  <Link to={'/about'} className="absolute top-2 left-2 w-32 h-14 border-2 border-white transition-transform hover:translate-x-1 hover:translate-y-1"/>
                </div>
              </div>
            </div>
          </div>
